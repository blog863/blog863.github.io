...
<div class="music-player">
  ...
  <div class="dash">
	...
	<audio controls autoplay loop>
        <source src="https://vercel.rryyz.com/free163person/音乐视听/印度歌曲/印度音乐-用爱对我.mp3" type="audio/mpeg">
    </audio>
	</div>
    <div class="info">
      <i><span name="current">0:00</span> / <span name="duration">0:00</span></i>
      <label>印度歌曲</label>
      <small>印度音乐-用爱对我</small>
