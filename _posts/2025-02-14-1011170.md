---
layout: post
title: "周深、于文文-暗香(Live)"
description: "周深、于文文-暗香(Live)"
categories: [精选]
tags: [精选]
redirect_from:
  - /2025/02/14/
...
<div class="music-player">
  ...
  <div class="dash">
	...
	<audio controls autoplay loop>
        <source src="https://vercel.rryyz.com/free163person/音乐视听/精选/周深、于文文-暗香(Live).mp3" type="audio/mpeg">
    </audio>
	</div>
    <div class="info">
      <i><span name="current">0:00</span> / <span name="duration">0:00</span></i>
      <label>精选</label>
      <small>周深、于文文-暗香(Live)</small>
