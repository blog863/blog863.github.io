---
layout: post
title: "0批量生成文件目录树列表.bat"
description: "0批量生成文件目录树列表.bat"
categories: [唯美纯音乐]
tags: [唯美纯音乐]
redirect_from:
  - /2018/02/14/
...
<div class="music-player">
  ...
  <div class="dash">
	...
	<audio controls autoplay loop>
        <source src="https://vercel.rryyz.com/free163person/音乐视听/唯美纯音乐/0批量生成文件目录树列表.bat.mp3" type="audio/mpeg">
    </audio>
	</div>
    <div class="info">
      <i><span name="current">0:00</span> / <span name="duration">0:00</span></i>
      <label>唯美纯音乐</label>
      <small>0批量生成文件目录树列表.bat</small>
